...
#					print data.data_type
					...
					if data.data_type == 2002:
						return
					if data.data_type == 2003:
						return
					if data.data_type == 2004:
						return
					if data.data_type == 2006: # image header
						return data.header
					if data.data_type == 2007: # command done
						return
					if data.data_type == 2008: # si image setting 
						return
					if data.data_type == 2009: # camera parameter structure
						return data
