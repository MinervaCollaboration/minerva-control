...
class Enum:
    ...
    def __init__(self, **kwargs):
        ...
        for k,v in self._namesToValues.items():
...
def main():
    ...
    raw_input("Press Enter to take an exposure")
    ...
    response = raw_input("Test the cooler? (y/n): ")
    if response.strip() == "y":
        raw_input("Press Enter to turn cooler on")
        ...
        raw_input("Press Enter to turn cooler off")
        coolerOff()
