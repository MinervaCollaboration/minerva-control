...
Set objLogFile = objFSO.OpenTextFile(strLogFile, OPEN_FILE_FOR_APPENDING)
Set objEngFile = objFSO.OpenTextFile(strEngFile, OPEN_FILE_FOR_APPENDING)
...
'  objCam.focMoveIn(focusOffset*-1)
'ElseIf FocusOffset > 0 Then
'  objCam.focMoveout(focusOffset)
'End If

'msgbox("test1")
test = objCam.focTemperature
msgbox(test)
wscript.quit
