...
SF_HalfSize = 150
SF_T   = (4090 / 2) - SF_HalfSize 
SF_R   = (4090 / 2) + SF_HalfSize
SF_B   = (4090 / 2) + SF_HalfSize
SF_L   = (4090 / 2) - SF_HalfSize
...
Do While ( MBAns < 7 )
	...
	If ( AdjAns < 7 ) Then
	  ...
	  objTele.GetRaDec
	  Y5min = OrientMult * ( 300 / 22.9 )
	  'Y5min = ( 300 / 22.9 )
	  X5min = OrientMult * ( 300 / 22.9 ) * Cos(PI * objTele.dDec / 180) 
